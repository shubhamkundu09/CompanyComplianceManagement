...
<html lang="en">
  ...
  <body>
    <div class="logo-bg">
      <img
        src="${pageContext.request.contextPath}/css/logo.png"
        alt="VNext LLP"
          ...
          <div style="position: relative">
            ...
            <div class="notification-dropdown" id="notificationDropdown">
              ...
              <div class="notification-footer">
                <a
                  href="${pageContext.request.contextPath}/company-admin/notifications"
          ...
          <div
            ...
            onclick="
              window.location.href =
                '${pageContext.request.contextPath}/company-admin/company-details'
            "
          >
          ...
          <div class="tab-content">
            <div id="tab-all" class="tab-pane active">
              ...
              >
                ...
                <a
                  href="${pageContext.request.contextPath}/company-admin/compliance/custom/create"
        ...
        <div style="margin-top: 20px">
          <div class="glass-card" style="padding: 20px">
            ...
            <div style="display: flex; gap: 12px; flex-wrap: wrap">
              <a
                href="${pageContext.request.contextPath}/company-admin/employees/add"
                class="btn btn-primary"
                ><i class="fas fa-user-plus"></i> Add Employee</a
              >
              <a
                href="${pageContext.request.contextPath}/company-admin/compliance/list"
                class="btn btn-ghost"
              ...
              <a
                href="${pageContext.request.contextPath}/company-admin/change-password"
                class="btn btn-ghost"
    ...
    <script>
      ...
      function buildVNextCard(c, clickFn, assignUrl, viewUrl) {
          ...
          var priority = c.priority || 0;  // <-- ADD THIS
          ...
          return (
              '<div class="compliance-card" onclick="' +
              clickFn +
              '">' +
              ...
              (assignUrl
                  ? '<button class="vnext-btn vnext-btn-gold" onclick="event.stopPropagation();window.location.href=\'' +
                  assignUrl +
                  "'\">" +
                  '<i class="fas fa-users"></i> Assign</button>'
                  : "") +
              (viewUrl
          ...
          try {
              ...
              if (data && data.success) {
                  ...
                  for (var i = 0; i < allCompliances.length; i++) {
                      ...
                      if (
                          item.subTemplateId !== null &&
                          item.subTemplateId !== undefined
                      ) {
                          ...
                          grouped[templateId].priority = item.priority || 0;  // <-- ADD THIS
                      }
                  }
                  groupedCompliances = Object.values(grouped);

                  // ===== FIX: Sort grouped compliances by priority =====
                  ...
                  for (var i = 0; i < groupedCompliances.length; i++) {
                      ...
                      if (group.subCompliances.length > 0) {
                          ...
                          var anyInProgress = statuses.some(function (s) {
                  ...
                  document.getElementById("complianceCardsGrid").style.display =
                      "grid";
                  if (groupedCompliances.length === 0)
                      document.getElementById("complianceEmptyState").style.display =
                          "block";
              } else {
                  document.getElementById("complianceLoader").style.display = "none";
                  document.getElementById("complianceEmptyState").style.display =
