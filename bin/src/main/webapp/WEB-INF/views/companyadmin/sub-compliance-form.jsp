...
<div class="app-wrapper">
     ...
     <!-- ==================== SIDEBAR ==================== -->
       <aside class="sidebar" id="sidebar">
               ...
               <a href="${pageContext.request.contextPath}/company-admin/compliance/custom/create" class="nav-item active">
    ...
    <main class="main-content">
        ...
        <div class="breadcrumb">
            ...
            <a href="${pageContext.request.contextPath}/company-admin/compliance/parents">My Compliances</a>
            <span class="sep"><i class="fas fa-chevron-right" style="font-size:9px;"></i></span>
            ...
            <div class="form-card">
                <form id="complianceForm" onsubmit="return false;">
                    ...
                    <div class="form-actions">
                        <a href="${pageContext.request.contextPath}/company-admin/compliance/parents" class="btn btn-ghost">
