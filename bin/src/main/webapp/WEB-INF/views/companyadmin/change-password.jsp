...
<head>
    ...
    <title>VNext Legal LLP — Change Password</title>
...
<div class="app-wrapper">
    ...
    <aside class="sidebar" id="sidebar">
            ...
            <a href="${pageContext.request.contextPath}/company-admin/change-password" class="nav-item active">
    ...
    <main class="main-content">
        ...
        <div class="page-header">
            ...
            <p style="font-size:13px;color:var(--gray-500);margin-top:4px;">Update your password to keep your account secure</p>
        </div>
...
<script>
    ...
    function validatePasswordStrength(password) {
        ...
        for (var i = 0; i < items.length; i++) {
            ...
            if (checks[keys[i]]) {
                ...
                el.innerHTML = '<i class="fas fa-check-circle"></i> ' + label;
            } else {
                el.className = 'req-item unmet';
                el.innerHTML = '<i class="fas fa-circle"></i> ' + label;
            }
        }
    ...
    async function submitPasswordChange() {
        ...
        try {
            const response = await api('/api/company-admin/change-password', {
                method: 'PUT',
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        async function loadEmployeeCount() {
            try {
                const data = await api('/api/company-admin/employees?page=0&size=1');
