    ...
    <div class="hero-panel">
        <div>
            <div class="hero-top">
                ...
                <img src="${baseUrl}/vnextimages/companyfiles/logo.png" alt="VNext LLP" class="logo-img" onerror="this.style.display='none'">
            ...
            try {
                ...
                if (response.ok && data.success) {
                    ...
                    setTimeout(() => {
                        ...
                        let target = 'super-admin/dashboard';
                        if (role === 'COMPANY_ADMIN') target = 'company-admin/dashboard';
                        else if (role === 'EMPLOYEE') target = 'employee/dashboard';
