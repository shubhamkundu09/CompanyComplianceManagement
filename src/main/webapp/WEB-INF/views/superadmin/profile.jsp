...
<div class="app-wrapper">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <a href="${baseUrl}/super-admin/profile" class="nav-item active">
        ...
        <div style="max-width: 800px; margin: 0 auto;">
            ...
            <div class="card" style="padding: 20px 24px; margin-top: 20px;">
                ...
                <div style="display: flex; gap: 12px; flex-wrap: wrap;">
                    <a href="${baseUrl}/change-password" class="btn btn-ghost">
                        <i class="fas fa-key"></i> Change Password
                    </a>
                    <a href="${baseUrl}/super-admin/dashboard" class="btn btn-ghost">
...
<script>
   ...
   async function loadDropdownNotifications() {
    ...
    function populateProfile(profile) {
        ...
        document.getElementById('phone').value = profile.phoneNumber || profile.phone || '';
    ...
    async function saveProfile() {
        ...
        try {
            ...
            // Update user data in localStorage (since we don't have a PUT endpoint)
