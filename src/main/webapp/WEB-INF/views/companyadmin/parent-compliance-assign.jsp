...
<div class="app-wrapper">
    ...
    <main class="main-content">
        ...
        <div class="breadcrumb">
            ...
            <a href="${baseUrl}/company-admin/compliance/parents">Compliance Categories</a>
            <span class="sep"><i class="fas fa-chevron-right" style="font-size:9px;"></i></span>
            <a href="${baseUrl}/company-admin/compliance/parent/${parentId}">Compliance Details</a>
            <span class="sep"><i class="fas fa-chevron-right" style="font-size:9px;"></i></span>
        ...
        <div id="pageContent" style="display:none;">
            ...
            <div class="assign-header">
                ...
                <div class="header-right">
                    <a href="${baseUrl}/company-admin/compliance/parent/${parentId}" class="btn btn-outline">
